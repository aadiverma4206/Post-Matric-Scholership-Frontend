...
public class AdminStudentDetailsViewModel
{
    ...
    public List<AdminStudentDocumentViewModel> Documents { get; set; } = new();
    public List<AdminStudentCertificateViewModel> Certificates { get; set; } = new();
    public List<AdminStudentVerificationViewModel> Verifications { get; set; } = new();
}
...
public class AdminStudentCertificateViewModel
{
    public ulong CertificateId { get; set; }
...
public class AdminStudentVerificationViewModel
{
...
public class AdminStudentListFilterViewModel
{
...
public class AdminDashboardStatsSummaryViewModel
{
